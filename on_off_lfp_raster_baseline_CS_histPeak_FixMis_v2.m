...
excel_path = 'E:\seizure\2024-01-02_WT_HOM-male-adult\2024-01-02_13-43-59\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP\clustertwo.xlsx';
...
out_xlsx = fullfile(pwd, 'swd_onset_aligned_rates.xlsx');
...
fprintf('[OK] Exported %d events, %d bins to %s\n', K, M, out_xlsx);
