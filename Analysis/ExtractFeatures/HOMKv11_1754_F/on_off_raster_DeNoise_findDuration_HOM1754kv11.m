...
% ==================   =======================================
base_path = 'D:\npxl_kv11\2025-02-10_1754_HOM_kv11-female-adult\2025-02-10_18-42-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP';
...
% === 4. 区域划分（阈值 1950）===
isCortex_type1   = depths_type1_clean > 1950;
isStriatum_type1 = depths_type1_clean <= 1950;

isCortex_type2   = depths_type2_clean > 1950;
isStriatum_type2 = depths_type2_clean <= 1950;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>1950): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<1950): %d\n', sum(isStriatum_type1));
...
isStr = depth_sel <= 1950;     % striatum
isCtx = depth_sel >  1950;     % cortex
...
isStr2 = depth_sel2 <= 1950;    % striatum
isCtx2 = depth_sel2 >  1950;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'D:\npxl_kv11\2025-02-10_1754_HOM_kv11-female-adult\2025-02-10_18-42-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251106_220111_withFinalPeaks.xlsx');
...
onset_base_dir = 'D:\npxl_kv11\2025-02-10_1754_HOM_kv11-female-adult\2025-02-10_18-42-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251106_215614.xlsx';
