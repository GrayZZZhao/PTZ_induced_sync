...
% ==================   =======================================
base_path = 'D:\2025PTZ\2025-04-28_986_HOM_male-adult\2025-04-28_16-29-44\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP';
...
% === 4. 区域划分（阈值 2720）===
isCortex_type1   = depths_type1_clean > 2720;
isStriatum_type1 = depths_type1_clean <= 2720;

isCortex_type2   = depths_type2_clean > 2720;
isStriatum_type2 = depths_type2_clean <= 2720;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>2720): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<=2720): %d\n', sum(isStriatum_type1));
...
isStr = depth_sel <= 2720;     % striatum
isCtx = depth_sel >  2720;     % cortex
...
isStr2 = depth_sel2 <= 2720;    % striatum
isCtx2 = depth_sel2 >  2720;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'D:\2025PTZ\2025-04-28_986_HOM_male-adult\2025-04-28_16-29-44\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251106_131542_withFinalPeaks.xlsx');
...
base_dir = 'D:\2025PTZ\2025-04-28_986_HOM_male-adult\2025-04-28_16-29-44\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
...
onset_base_dir = 'D:\2025PTZ\2025-04-28_986_HOM_male-adult\2025-04-28_16-29-44\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251106_121229.xlsx';
