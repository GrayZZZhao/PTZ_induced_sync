...
% ==================   =======================================
base_path = 'D:\npxl_kv11\2025-04-22_639_639_HOM_kv11control-male-adult\2025-04-22_15-45-09\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP';
...
unitType_path         = fullfile(base_path, 'unitType_haode.mat');
...
% === 4. 区域划分（阈值 2880）===
isCortex_type1   = depths_type1_clean > 2880;
isStriatum_type1 = depths_type1_clean <= 2880;

isCortex_type2   = depths_type2_clean > 2880;
isStriatum_type2 = depths_type2_clean <= 2880;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>2880): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<=2880): %d\n', sum(isStriatum_type1));
...
isStr = depth_sel <= 2880;     % striatum
isCtx = depth_sel >  2880;     % cortex
...
isStr2 = depth_sel2 <= 2880;    % striatum
isCtx2 = depth_sel2 >  2880;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'D:\npxl_kv11\2025-04-22_639_639_HOM_kv11control-male-adult\2025-04-22_15-45-09\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251105_142941_withFinalPeaks.xlsx');
...
onset_base_dir = 'D:\npxl_kv11\2025-04-22_639_639_HOM_kv11control-male-adult\2025-04-22_15-45-09\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251105_140324.xlsx';
