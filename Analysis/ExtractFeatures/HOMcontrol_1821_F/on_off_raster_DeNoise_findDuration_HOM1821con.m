...
% ==================   =======================================
base_path = 'E:\1821_HOM_F_con\2025-07-20_15-33-53\Record Node 101\experiment1\recording3\continuous\Neuropix-PXI-100.ProbeA-AP';
...
% === 4. 区域划分（阈值 2800）===
isCortex_type1   = depths_type1_clean > 2800;
isStriatum_type1 = depths_type1_clean <= 2800;

isCortex_type2   = depths_type2_clean > 2800;
isStriatum_type2 = depths_type2_clean <= 2800;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>2800): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<2800): %d\n', sum(isStriatum_type1));
...
loading_lfp
%
% d_shift = [d(:, 10176:end), zeros(size(d,1), 10175)];
% %
% d= d_shift;
...
isStr = depth_sel <= 2800;     % striatum
isCtx = depth_sel >  2800;     % cortex
...
isStr2 = depth_sel2 <= 2800;    % striatum
isCtx2 = depth_sel2 >  2800;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'E:\1821_HOM_F_con\2025-07-20_15-33-53\Record Node 101\experiment1\recording3\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251124_201930_withFinalPeaks.xlsx');
...
base_dir = 'E:\1821_HOM_F_con\2025-07-20_15-33-53\Record Node 101\experiment1\recording3\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
...
onset_base_dir = 'E:\1821_HOM_F_con\2025-07-20_15-33-53\Record Node 101\experiment1\recording3\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251124_195852.xlsx';
