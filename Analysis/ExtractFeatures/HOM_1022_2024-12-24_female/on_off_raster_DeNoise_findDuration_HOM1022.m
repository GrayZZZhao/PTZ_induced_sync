...
% ==================   =======================================
base_path = 'D:\2025PTZ\2025-04-30_1022_HOM-female-adult\2025-04-30_11-54-07\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP';
...
unitType_path         = fullfile(base_path, 'unitType_haoduo.mat');
...
% === 4. 区域划分（阈值 2500）===
isCortex_type1   = depths_type1_clean > 2500;
isStriatum_type1 = depths_type1_clean <= 2500;

isCortex_type2   = depths_type2_clean > 2500;
isStriatum_type2 = depths_type2_clean <= 2500;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>2500): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<=2500): %d\n', sum(isStriatum_type1));
...
loading_lfp
%
% d_shift = [d(:, 3875:end), zeros(size(d,1), 3875)];
% %
% d= d_shift;
...
colormap(custom_cmap); caxis(clim)
...
isStr = depth_sel <= 2500;     % striatum
isCtx = depth_sel >  2500;     % cortex
...
isStr2 = depth_sel2 <= 2500;    % striatum
isCtx2 = depth_sel2 >  2500;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'D:\2025PTZ\2025-04-30_1022_HOM-female-adult\2025-04-30_11-54-07\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251106_105307_withFinalPeaks.xlsx');
...
% Visualization layout
% =========================================================
x_start = 386;                       % Starting time in seconds (fixed)
x_end   = 388;                       % Ending time in seconds (fixed)
...
base_dir = 'D:\2025PTZ\2025-04-30_1022_HOM-female-adult\2025-04-30_11-54-07\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
...
onset_base_dir = 'D:\2025PTZ\2025-04-30_1022_HOM-female-adult\2025-04-30_11-54-07\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251106_100459.xlsx';
