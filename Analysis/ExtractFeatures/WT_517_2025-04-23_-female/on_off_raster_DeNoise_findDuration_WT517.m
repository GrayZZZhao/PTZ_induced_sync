...
% ==================   =======================================
base_path = 'F:\YlabPTZnxpxlrecording\2025\2025-04-23_517_WT-female-adult\2025-04-23_16-31-14\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP';
...
% === 4. 区域划分（阈值 2200）===
isCortex_type1   = depths_type1_clean > 2200;
isStriatum_type1 = depths_type1_clean <= 2200;

isCortex_type2   = depths_type2_clean > 2200;
isStriatum_type2 = depths_type2_clean <= 2200;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>2200): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<=2200): %d\n', sum(isStriatum_type1));
...
isStr = depth_sel <= 2200;     % striatum
isCtx = depth_sel >  2200;     % cortex
...
isStr2 = depth_sel2 <= 2200;    % striatum
isCtx2 = depth_sel2 >  2200;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'F:\YlabPTZnxpxlrecording\2025\2025-04-23_517_WT-female-adult\2025-04-23_16-31-14\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251105_180651_withFinalPeaks.xlsx');
...
base_dir = 'F:\YlabPTZnxpxlrecording\2025\2025-04-23_517_WT-female-adult\2025-04-23_16-31-14\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
...
onset_base_dir = 'F:\YlabPTZnxpxlrecording\2025\2025-04-23_517_WT-female-adult\2025-04-23_16-31-14\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251105_174817.xlsx';
