...
% ==================   =======================================
base_path = 'F:\YlabPTZnxpxlrecording\2025\2025-04-25_520_WT-female-adult\2025-04-25_11-40-47\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP';
...
% === 4. 区域划分（阈值 2400）===
isCortex_type1   = depths_type1_clean > 2400;
isStriatum_type1 = depths_type1_clean <= 2400;

isCortex_type2   = depths_type2_clean > 2400;
isStriatum_type2 = depths_type2_clean <= 2400;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>2400): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<=2400): %d\n', sum(isStriatum_type1));
...
isStr = depth_sel <= 2400;     % striatum
isCtx = depth_sel >  2400;     % cortex
...
isStr2 = depth_sel2 <= 2400;    % striatum
isCtx2 = depth_sel2 >  2400;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'F:\YlabPTZnxpxlrecording\2025\2025-04-25_520_WT-female-adult\2025-04-25_11-40-47\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251105_211911_withFinalPeaks.xlsx');
...
base_dir = 'F:\YlabPTZnxpxlrecording\2025\2025-04-25_520_WT-female-adult\2025-04-25_11-40-47\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
...
onset_base_dir = 'F:\YlabPTZnxpxlrecording\2025\2025-04-25_520_WT-female-adult\2025-04-25_11-40-47\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251105_210237.xlsx';
