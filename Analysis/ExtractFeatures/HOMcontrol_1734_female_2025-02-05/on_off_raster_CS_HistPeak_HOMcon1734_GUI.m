...
excel_path = 'D:\npxl_kv11\2025-02-05_1734_HOM_kv11control-female-adult\2025-02-05_15-24-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP\clustertwo.xlsx';
...
%% ========================================================================
%  A) Build onset-aligned population rates for ALL events (CTX & STR)
% ========================================================================
% Uses: swd_real_onset_FixMiss, original_sampling_rate, resultArray_wt,
...
% ---- all onsets in seconds (vector Kx1) ----
onset_sec_all = swd_real_onset_FixMiss(:);
K             = numel(onset_sec_all);
...
for k = 1:K
    ...
    rate_CTX_all(k, :) = cnt_CTX / bin_width_hist;   % spikes/s
