...
% ==================   =======================================
base_path = 'D:\npxl_kv11\2025-02-05_1734_HOM_kv11control-female-adult\2025-02-05_15-24-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP';
...
unitType_path         = fullfile(base_path, 'unitType_haoduo_1TWO2.mat');
...
% === 4. 区域划分（阈值 3000）===
isCortex_type1   = depths_type1_clean > 3000;
isStriatum_type1 = depths_type1_clean <= 3000;

isCortex_type2   = depths_type2_clean > 3000;
isStriatum_type2 = depths_type2_clean <= 3000;

% === 5. 输出 ===
fprintf('\nType 1 neurons (after removing NaN): %d\n', numel(depths_type1_clean));
fprintf('  Cortex  (>3000): %d\n', sum(isCortex_type1));
fprintf('  Striatum(<3000): %d\n', sum(isStriatum_type1));
...
loading_lfp
%
d_shift = [d(:, 15017:end), zeros(size(d,1), 15017)];
%
d= d_shift;
...
isStr = depth_sel <= 3000;     % striatum
isCtx = depth_sel >  3000;     % cortex
...
isStr2 = depth_sel2 <= 3000;    % striatum
isCtx2 = depth_sel2 >  3000;    % cortex
...
% 目标 Excel 路径
peak_dir  = 'D:\npxl_kv11\2025-02-05_1734_HOM_kv11control-female-adult\2025-02-05_15-24-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
peak_file = fullfile(peak_dir, 'qualityMatrix_20251105_093832_withFinalPeaks.xlsx');
...
onset_base_dir = 'D:\npxl_kv11\2025-02-05_1734_HOM_kv11control-female-adult\2025-02-05_15-24-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-LFP\Str_Cor_histPeak_diff';
onset_file     = 'swd_real_onset_FixMiss_20251103_232551.xlsx';
