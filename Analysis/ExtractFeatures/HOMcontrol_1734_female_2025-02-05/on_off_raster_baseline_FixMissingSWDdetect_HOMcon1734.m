...
loading_lfp
%%
d_shift = [d(:, 3225:end), zeros(size(d,1), 3225)];
%%
d= d_shift;
...
spike_time_wt = readNPY('D:\npxl_kv11\2025-02-05_1734_HOM_kv11control-female-adult\2025-02-05_15-24-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP\spike_times.npy');
spike_time_full_wt = double(spike_time_wt) / 30000;
spike_templates_wt = readNPY('D:\npxl_kv11\2025-02-05_1734_HOM_kv11control-female-adult\2025-02-05_15-24-06\Record Node 101\experiment1\recording2\continuous\Neuropix-PXI-100.ProbeA-AP\spike_templates.npy');
...
selected_neurons = find(burst_to_non_burst_rate_ratio >0);  %(<0.5 meaning off,    >2 meaing 0n )
