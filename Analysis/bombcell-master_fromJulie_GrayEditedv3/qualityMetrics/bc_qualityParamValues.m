...
param.maxPercSpikesMissing = 30;  %%% GZ changed from 20 to 30 according to Julie's nature paper  
...
param.minAmplitude = 77;  %%% GZ changed from 20 to 70 
% recording parametrs
param.ephys_sample_rate = 30000;
param.nChannels = 384;  %%% GZ changed from 385 to 384
